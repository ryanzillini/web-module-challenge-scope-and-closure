...
/*Task 1: counterMaker()
  ...
  counter2 will return numbers ascending in value while counter1 will return 0 every time
  2. Which of the two uses a closure? How can you tell?
  they both use closure as they both use functions
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  counter2 would be better for giving customers a number in line which would dictate the order in which they will be called/ first come first serve.
    counter1 is better for a situation where everyone should receive the same number given their input such as an ATM.
*/
...
function scoreboard(inningScoreCB, inningCB, numInnings) {
  ...
  if(homeScore === awayScore) {
    scoreByInning.push(`This game will require extra innings: Away ${currentInning.Away} - ${currentInning.Home}`)
  }else{
